#ifndef EXPONENTIALDISTRIBUTIONIDEA_H
#define EXPONENTIALDISTRIBUTIONIDEA_H
...
struct ExponentialDistributionAttributes : public IdeaAttributes
{
    ExponentialDistributionAttributes();
};

class ExponentialDistributionIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit ExponentialDistributionIdea();
...
#endif // EXPONENTIALDISTRIBUTIONIDEA_H
