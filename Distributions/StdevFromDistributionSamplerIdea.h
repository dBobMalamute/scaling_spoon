#ifndef STDEVFROMDISTRIBUTIONSAMPLERIDEA_H
#define STDEVFROMDISTRIBUTIONSAMPLERIDEA_H
...
struct StdevFromDistributionSamplerAttributes : public IdeaAttributes
{
    StdevFromDistributionSamplerAttributes();
};

class StdevFromDistributionSamplerIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit StdevFromDistributionSamplerIdea();
...
#endif // STDEVFROMDISTRIBUTIONSAMPLERIDEA_H
