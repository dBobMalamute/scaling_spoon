#ifndef VARIANCEFROMDISTRIBUTIONSAMPLERFIXEDMEANIDEA_H
#define VARIANCEFROMDISTRIBUTIONSAMPLERFIXEDMEANIDEA_H
...
struct VarianceFromDistributionSamplerFixedMeanAttributes : public IdeaAttributes
{
    VarianceFromDistributionSamplerFixedMeanAttributes();
};

class VarianceFromDistributionSamplerFixedMeanIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit VarianceFromDistributionSamplerFixedMeanIdea();
...
#endif // VARIANCEFROMDISTRIBUTIONSAMPLERFIXEDMEANIDEA_H
