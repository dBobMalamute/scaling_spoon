...
Rectangle
{
    ...
    Connections
    {
        ...
        function onDisplayNumbers(input, output)
        {
            ...
            if(output <= 10000 && input >= 0)
            {
                ...
                multiplyByEButton.enabled = true
            ...
            {
                multiplyByEButton.enabled = false;
    ...
    Rectangle
    {
        ...
        Image
        {
            ...
            source: "qrc:/Images/1toEPicture.png"
        }
    ...
    Rectangle
    {
        ...
        Text
        {
            ...
            color: "#e8e8e8"
            font.pointSize: 10
            //text: multiplications.toFixed(3);
        }
    }
    ...
    {
        if(Math.E*currentlyShownBoxes <= outputNumber)
        {
            currentlyShownBoxes *= Math.E;
            multiplications += 1;
