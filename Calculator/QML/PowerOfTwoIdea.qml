...
Rectangle
{
    ...
    Connections
    {
        ...
        function onDisplayNumbers(input, output)
        {
            ...
            if(output <= 10000 && input >= 0)
            {
                ...
                multiplyByTwoButton.enabled = true
            ...
            {
                multiplyByTwoButton.enabled = false;
    ...
    Rectangle
    {
        ...
        Image
        {
            ...
            source: "qrc:/Images/1to2Picture.png"
        }
    ...
    {
        if(2*currentlyShownBoxes <= outputNumber)
        {
            currentlyShownBoxes *= 2;
            multiplications += 1;
