#ifndef DISTRIBUTIONSTANDARDDEVIATIONIDEA_H
#define DISTRIBUTIONSTANDARDDEVIATIONIDEA_H
...
struct DistributionStandardDeviationAttributes : public IdeaAttributes
{
    DistributionStandardDeviationAttributes();
};

class DistributionStandardDeviationIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit DistributionStandardDeviationIdea();
...
#endif // DISTRIBUTIONSTANDARDDEVIATIONIDEA_H
