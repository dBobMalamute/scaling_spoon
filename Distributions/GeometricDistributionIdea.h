#ifndef GEOMETRICDISTRIBUTIONIDEA_H
#define GEOMETRICDISTRIBUTIONIDEA_H
...
struct GeometricDistributionAttributes : public IdeaAttributes
{
    GeometricDistributionAttributes();
};

class GeometricDistributionIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit GeometricDistributionIdea();
...
#endif // GEOMETRICDISTRIBUTIONIDEA_H
