#ifndef NEGATIVEBINOMIALDISTRIBUTIONIDEA_H
#define NEGATIVEBINOMIALDISTRIBUTIONIDEA_H
...
struct NegativeBinomialDistributionAttributes : public IdeaAttributes
{
    NegativeBinomialDistributionAttributes();
};

class NegativeBinomialDistributionIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit NegativeBinomialDistributionIdea();
...
#endif // NEGATIVEBINOMIALDISTRIBUTIONIDEA_H
