#ifndef LOGNORMALDISTRIBUTIONIDEA_H
#define LOGNORMALDISTRIBUTIONIDEA_H
...
struct LogNormalDistributionAttributes : public IdeaAttributes
{
    LogNormalDistributionAttributes();
};

class LogNormalDistributionIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit LogNormalDistributionIdea();
...
#endif // LOGNORMALDISTRIBUTIONIDEA_H
